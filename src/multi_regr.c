...
void bootstrap(double x[], double y[], double *result, size_t b, size_t B, size_t n, size_t d) {
...
double result[ d ];
 ...
 bootstrap(x, y, result, b, B,  n,  d) ;

 	for (int i = 0; i < d; i++){
		printf("The st dev of the coefficient i %d is %f \n", i, result[ i ] );
	}
